...
export const BookingWizard: React.FC<BookingWizardProps> = ({
  ...
  const handleDateChange = (newDate: string) => {
    ...
    if (newDate) {
      onShowToast(
        'Fecha seleccionada',
        'La disponibilidad todavía debe confirmarse en la agenda antes de apartar el evento.',
        'info'
      );
    }
  };
            ...
            <div className="space-y-6">
              <div className="space-y-1">
                ...
                <p className="text-xs text-gray-400">
                  Esta selección no bloquea ni confirma la fecha. Primero se revisa la agenda y después se confirma contigo por WhatsApp.
                </p>
              </div>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              ...
              <div className="p-5 rounded-2xl bg-[#0B0F17] border border-white/10 space-y-3 text-xs">
                ...
                <div className="flex justify-between gap-4">
                  <span className="text-gray-400">Precio de referencia</span>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onUpdateBookingState((prev) => ({ ...prev, clientName: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onUpdateBookingState((prev) => ({ ...prev, clientEmail: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onUpdateBookingState((prev) => ({ ...prev, clientPhone: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onUpdateBookingState((prev) => ({ ...prev, eventCity: e.target.value }))}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => onUpdateBookingState((prev) => ({ ...prev, notes: e.target.value }))}
                  rows={3}
