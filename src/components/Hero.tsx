...
export const Hero: React.FC<HeroProps> = ({ currentRoute, onQuoteClick, onGalleryClick, onCitaClick }) => {
  ...
  > = {
    inicio: {
      ...
      subtitle:
        'Cobertura para bodas, XV años, bautizos, retratos y proyectos empresariales. Revisa opciones, arma una cotización y solicita disponibilidad directamente.',
    ...
    bodas: {
      ...
      subtitle:
        'Coberturas para boda civil y celebraciones completas, con opciones de sesión previa, fotografía, video y entregables digitales.',
    ...
    'xv-anos': {
      ...
      subtitle:
        'Opciones de cobertura para ceremonia, vals y fiesta, además de paquetes profesionales con preparación y entregables digitales.',
    ...
    bautizos: {
      ...
      subtitle:
        'Cuéntanos duración, ceremonia, recepción y ubicación para preparar una propuesta adecuada a tu evento.',
    ...
    retratos: {
      ...
      subtitle:
        'Sesiones personales, de pareja, graduación o editoriales cotizadas según duración, locación y producción.',
    ...
    empresarial: {
      ...
      highlight: 'negocio',
      subtitle:
        'Headshots, branding y cobertura corporativa cotizados según número de personas, duración y entregables requeridos.',
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          <div className="lg:col-span-7 space-y-6 sm:space-y-7 text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-1 text-xs font-medium text-gray-300">
              ...
              <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/5 border border-white/10">
                <CalendarCheck className="w-4 h-4 text-[#D4AF37] shrink-0" />
                <span>Agenda confirmada personalmente</span>
              </div>
              <div className="flex items-center gap-2 p-2.5 rounded-xl bg-white/5 border border-white/10">
                <MapPin className="w-4 h-4 text-[#D4AF37] shrink-0" />
                <span>CDMX & zona centro</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              ...
              >
                ...
                <span>Ver referencias visuales</span>
              </button>
            </div>
          </div>
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/15 bg-[#161C28] p-2 shadow-2xl shadow-black/80">
                <div className="relative h-[420px] sm:h-[460px] rounded-xl overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-[#0B0F17]/80 backdrop-blur-md border border-white/10">
                    ...
                    <p className="text-xs text-gray-400 mt-1">La galería utiliza imágenes de referencia mientras se integra el portafolio final.</p>
                  </div>
                </div>
              </div>
            </div>
