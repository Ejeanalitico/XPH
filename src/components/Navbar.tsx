    ...
    <header className="sticky top-0 z-40 w-full backdrop-blur-xl bg-[#0B0F17]/90 border-b border-white/10 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        <div className="flex items-center gap-4 min-w-0">
          ...
          >
            ...
            <div className="min-w-0">
              <span className="text-base sm:text-lg xl:text-xl font-bold tracking-wide font-serif-luxury text-white block truncate">
        ...
        <nav className="hidden md:flex items-center gap-4 text-sm font-medium text-gray-300">
          ...
          <button onClick={() => scrollToSection('cierre-presencial')} className="hidden lg:flex hover:text-[#D4AF37] transition-colors py-1 cursor-pointer items-center gap-1">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#0B0F17] border-b border-white/10 px-4 pt-3 pb-6 space-y-4">
          ...
          <div className="pt-2 border-t border-white/10 flex flex-col gap-2 font-medium text-gray-300">
            ...
            <button onClick={() => scrollToSection('cierre-presencial')} className="text-left py-2 border-b border-white/5 hover:text-[#D4AF37]">Cita presencial</button>
