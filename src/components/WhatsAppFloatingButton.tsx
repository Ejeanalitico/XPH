...
export const WhatsAppFloatingButton: React.FC<WhatsAppFloatingButtonProps> = ({
  ...
  const activeAddonsNames = bookingState.selectedAddons
    .map((id) => ADDONS_CATALOG.find((addon) => addon.id === id)?.name || '')
    .filter(Boolean);
