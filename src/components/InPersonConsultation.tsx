    ...
    <section id="cierre-presencial" className="py-20 relative overflow-hidden bg-gradient-to-b from-[#0B0F17] via-[#111723] to-[#0B0F17]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-[#D4AF37] text-xs font-semibold tracking-wider uppercase mb-4 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          {/* Step 1 */}
          <div className="relative p-8 rounded-2xl bg-[#161C28]/80 border border-white/10 hover:border-[#D4AF37]/40 transition-all group backdrop-blur-md flex flex-col justify-between">
            <div className="absolute top-6 right-6 text-4xl font-black text-[#D4AF37]/10 group-hover:text-[#D4AF37]/20 transition-colors font-mono">
              01
            </div>

            <div>
              <div className="w-14 h-14 rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/30 flex items-center justify-center text-[#D4AF37] mb-6 group-hover:scale-110 transition-transform">
          ...
          {/* Step 2 */}
          <div className="relative p-8 rounded-2xl bg-[#161C28]/80 border border-[#D4AF37]/40 shadow-xl shadow-[#D4AF37]/5 transition-all group backdrop-blur-md flex flex-col justify-between">
            <div className="absolute top-6 right-6 text-4xl font-black text-[#D4AF37]/20 font-mono">
              02
            </div>

            <div>
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#D4AF37] to-[#AA771C] flex items-center justify-center text-[#0B0F17] mb-6 group-hover:scale-110 transition-transform shadow-lg shadow-[#D4AF37]/20">
                <MapPin className="w-7 h-7" />
              </div>

              <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
                Visita Presencial en CDMX
                <span className="px-2 py-0.5 text-[10px] rounded bg-[#D4AF37]/20 text-[#D4AF37] border border-[#D4AF37]/40">CDMX</span>
              </h3>
        ...
        <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-r from-[#161C28] via-[#1A2232] to-[#161C28] border border-[#D4AF37]/30 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-bold text-sm tracking-wide hover:from-emerald-600 hover:to-emerald-700 transition-all shadow-xl shadow-emerald-500/20 flex items-center justify-center gap-3 group cursor-pointer"
            >
              <PhoneCall className="w-5 h-5 group-hover:rotate-12 transition-transform" />
              <span>Agendar Cita Presencial vía WhatsApp</span>
            </button>
