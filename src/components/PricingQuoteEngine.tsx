      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
        ...
        {!isCustomQuote ? <div className="grid lg:grid-cols-2 gap-8">
          <div className="rounded-2xl bg-[#161C28] border border-white/10 p-6 space-y-5">
            <div><h3 className="text-xl font-bold text-white">Personaliza tu cobertura</h3><p className="text-xs text-gray-400 mt-1">Adicionales publicados desde el administrador.</p></div>
